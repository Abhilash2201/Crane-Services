...
const StyledTextarea = styled.textarea`
  width: 100%; min-height: 96px; border: 1px solid ${({ theme }) => theme.colors.border}; border-radius: 12px;
  padding: 10px 12px; background: ${({ theme }) => theme.colors.white}; font: inherit; resize: vertical;
