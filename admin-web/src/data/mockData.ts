export const kpis = [
  ...
  {
    label: "Total Cranes Onboarded",
    value: "3,962",
    delta: "+48 new this month",
    tone: "info",
  },
  {
...
export const users = [
  {
    ...
    email: "rohan.mehta@urbansite.in",
    city: "Bengaluru",
    joined: "12 Jan 2025",
    status: true,
    verified: true,
  },
  {
    role: "Customers",
    name: "Priya Nair",
    phone: "+91 99872 44510",
    email: "priya.nair@skylineprojects.in",
    city: "Mumbai",
    joined: "24 Mar 2025",
    status: true,
    verified: true,
  ...
  {
    role: "Crane Owners",
    name: "Rajesh Crane Services",
    phone: "+91 98450 55001",
    email: "ops@rajeshcranes.com",
    city: "Bengaluru",
    joined: "03 Nov 2024",
    status: true,
    verified: true,
  ...
  {
    role: "Crane Owners",
    name: "Shree Lifts Pvt Ltd",
    phone: "+91 98204 80332",
    email: "admin@shreelifts.in",
    city: "Mumbai",
    joined: "18 Dec 2024",
    status: false,
    verified: false,
  },
  {
    role: "Drivers",
    name: "Imran Shaikh",
    phone: "+91 97681 55221",
    email: "imran.shaikh@fleetmail.in",
    city: "Delhi",
    joined: "08 Aug 2025",
    status: true,
    verified: true,
  },
  {
    role: "Drivers",
    name: "Sandeep Yadav",
    phone: "+91 99587 11029",
    email: "sandeep.y@fleetmail.in",
    city: "Delhi",
    joined: "17 Sep 2025",
    status: true,
    verified: false,
  },
  {
    role: "Drivers",
    name: "Harsha Gowda",
    phone: "+91 99007 33124",
    email: "harsha.g@fleetmail.in",
    city: "Bengaluru",
    joined: "02 Oct 2025",
    status: false,
    verified: true,
...
export const serviceRequests = [
  {
    id: "CRH-REQ-90211",
    customer: "UrbanEdge Infra",
    variant: "50T Rough Terrain",
    location: "Whitefield, Bengaluru",
    time: "01 Mar 2026, 10:30 AM",
    status: "Confirmed",
    owner: "Rajesh Crane Services",
    driver: "Harsha Gowda",
  },
  {
    id: "CRH-REQ-90207",
    customer: "Mahalaxmi Projects",
    variant: "25T Mobile Crane",
    location: "Andheri East, Mumbai",
    time: "01 Mar 2026, 09:15 AM",
    status: "In Progress",
    owner: "Metro Crane Logistics",
    driver: "Imran Shaikh",
  },
  {
    id: "CRH-REQ-90198",
    customer: "Northline Buildcon",
    variant: "100T Crawler Crane",
    location: "Dwarka, Delhi",
    time: "28 Feb 2026, 04:45 PM",
    status: "Accepted",
    owner: "Rajput Heavy Lifts LLP",
    driver: "Sandeep Yadav",
  },
  {
    id: "CRH-REQ-90181",
    customer: "Kaveri Developers",
    variant: "Tower Crane",
    location: "Hebbal, Bengaluru",
    time: "28 Feb 2026, 01:10 PM",
    status: "Open",
    owner: "-",
    driver: "-",
  },
  {
    id: "CRH-REQ-90162",
    customer: "Skyline Metro Works",
    variant: "25T Mobile Crane",
    location: "BKC, Mumbai",
    time: "27 Feb 2026, 11:00 AM",
    status: "Completed",
    owner: "Shree Lifts Pvt Ltd",
    driver: "Faisal Khan",
  },
];
...
export const disputes = [
  {
    id: "DSP-184",
    requestId: "CRH-REQ-90201",
    complainant: "Priya Nair",
    reason: "Late crane arrival by 90 minutes",
    status: "Under Review",
  },
  {
    id: "DSP-177",
    requestId: "CRH-REQ-90178",
    complainant: "Rajesh Crane Services",
    reason: "Incorrect overtime charge",
    status: "Resolved",
  },
  {
    id: "DSP-171",
    requestId: "CRH-REQ-90155",
    complainant: "Northline Buildcon",
